...
function Signup() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-l from-[#059669] to-black">
            <div className="w-full max-w-md">
                <div className="text-center mb-10">
                    <h1 className="text-4xl font-bold font-heading  text-[#34D399]/50 mb-2">Resume Craft AI</h1>
                    <p className="text-white/90">Create your account</p>
                </div>

                <form onSubmit={handleSignup} className="bg-black/50 p-8 rounded-xl shadow-lg">
                    <h2 className="text-2xl font-bold mb-6 text-[#34D399]/50">Sign Up</h2>
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className={`w-full bg-[#059669]/70 text-white py-3 px-4 rounded-lg font-medium transition duration-200 ${isLoading ? 'bg-[#059669]/70 cursor-not-allowed' : 'hover:bg-[#10B981]'
                            }`}
                    >
                        {isLoading ? (
                    ...
                    <div className="text-center mt-6">
                        <p className="text-white/70">
                            ...
                            <Link to="/login" className="text-[#34D399]/50 hover:underline font-medium">
                                Sign in
                            </Link>
                        </p>
                    </div>
                ...
                <div className="text-center mt-8">
                    <p className="text-sm text-white/70">
                        © {new Date().getFullYear()} Resume Craft AI. All rights reserved.
                    </p>
                </div>
            </div>
        </div>
