          ...
          {loading ? (
            ...
            <>
              <div className="bg-black/50 rounded-xl shadow-md overflow-hidden mb-8 border border-gray-100">
                <div className="bg-black/50 px-8 py-5 text-[#34D399]/50">
                  <h2 className="text-xl text-[#34D399]/50 font-bold">Profile Selection</h2>
                ...
                <div className="p-8">
                  {profiles.length === 0 ? (
                    <div className="text-center py-8">
                      ...
                      <Link
                        to="/upload"
                        className="mt-4 inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#34D399]/50 hover:bg-[#10B981]"
                      >
                        Upload Resume
                      </Link>
                    </div>
                    ...
                    <>
                      ...
                      <div className="flex items-center">
                        <div className="relative flex-grow">
                          <select
                            className="block w-full pl-3 pr-10 py-3 text-base border-gray-300 focus:outline-none focus:ring-[#34D399]/50 focus:border-[#34D399]/50 rounded-lg shadow-sm"
              ...
              <div className="flex justify-end space-x-4">
                ...
                {currentProfile && (
                  <>
                    <Link
                      to="/job-matcher"
                      className="px-5 py-2.5 bg-[#34D399]/50 hover:bg-[#10B981] text-white font-medium rounded-lg shadow hover:shadow-md transition duration-150 flex items-center mr-3"
                    >
                    ...
                    <Link
                      to="/hr-interview-practice"
                      className="px-5 py-2.5 bg-[#059669]/50 hover:bg-[#10B981] text-white font-medium rounded-lg shadow hover:shadow-md transition duration-150 flex items-center"
                    >
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                      </svg>
                      TR Interview Practice
                    </Link>
                    <Link
                      to="/cv-generator"
                      className="px-5 py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-medium rounded-lg shadow hover:shadow-md transition duration-150 flex items-center"
                    >
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
