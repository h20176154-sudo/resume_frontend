...
const ResumeBuilder = () => {
      ...
      {["personal", "skills", "projects", "mini-projects", "experience", "education"].map((tab) => (
        <button
          ...
          className={`px-4 py-2 font-medium transition-colors whitespace-nowrap ${
            activeTab === tab
              ? "border-b-2 border-[#34D399]/50  text-[#34D399]/50 "
              : "text-[#34D399]/50  hover:text-[#34D399]"
          }`}
        >
  ...
  return (
    <div className="bg-gradient-to-l from-[#059669] to-black min-h-screen py-10">
      <div className="max-w-4xl mx-auto bg-black/50 rounded-lg shadow-xl overflow-hidden">
        <div className="bg-gradient-to-r from-black/30 to-[#059669] p-6 text-white">
          <h1 className="text-3xl font-heading font-bold">Professional Resume Builder</h1>
          <p className="text-[#6EE7B7]">Create a polished, professional resume in minutes</p>
        </div>
      ...
      <div className="max-w-4xl mx-auto text-center mt-8 text-white/70 text-sm">
        &copy; {new Date().getFullYear()} Resume Craft AI. All rights reserved.
      </div>
    </div>
  );
};
