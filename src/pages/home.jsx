...
const steps = [
  ...
  { id: 2, title: "Parse & Manage", desc: "Resume Craft AI extracts structured data and manages multiple profiles." },
  ...
  return (
    ...
    <>
      <div className="fixed top-0 left-0 w-full h-1 bg-gray z-50">
        <motion.div
          className="h-1 bg-gradient-to-r from-[#059669] via-[#10B981] to-[#34D399]"
        ...
        <Navbar/>
      <div className="min-h-screen relative overflow-hidden bg-gradient-to-l from-[#059669] to-black py-16 flex items-center px-6 md:px-20   ">
      ...
      <h1 className="text-5xl md:text-6xl font-extrabold text-white leading-tight drop-shadow-2xl font-heading animate-fadeIn">
        Resume Craft
        <span className="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-[#34D399] to-[#6EE7B7]">
          AI
        </span>
      </h1>

      <p className="text-white/95 md:text-xl max-w-xl leading-relaxed font-body font-medium animate-fadeIn delay-200">
        Resume Craft AI is a <span className="font-semibold text-[#34D399]"> platform</span> that connects <span className="font-semibold text-[#34D399]">job seekers</span> with their ideal positions.
      </p>
      <p className="text-white/90 md:text-lg max-w-xl leading-relaxed font-body animate-fadeIn delay-400">
        Using <span className="font-semibold text-[#6EE7B7]">advanced text analysis</span> and skill extraction algorithms, it evaluates resumes and compares them to job descriptions.
      </p>
      <p className="text-white/90 md:text-lg max-w-xl leading-relaxed font-body animate-fadeIn delay-600">
        It then provides <span className="font-semibold text-[#34D399]">actionable insights</span> to boost your chances of landing interviews.
      </p>

      {/* CTA Buttons */}
      <div className="flex gap-4 flex-wrap mt-4 animate-fadeIn delay-800">
        <Link to={'/upload'} className="bg-[#34D399] text-black font-semibold px-6 py-3 rounded-full shadow-lg hover:bg-[#6EE7B7] transition duration-300 font-body">
          Get Started
        </Link>
      <Link to='#' target="_blank"
        ...
        <div className="flex-1 relative z-10 justify-center items-center flex">
          <div className=" absolute w-72 h-72 md:w-96 md:h-96 rounded-full bg-[#34D399]/40 blur-3xl animate-plus"></div>
            <img src="logo.jpg" alt="logo" className="w-64 h-64 md:w-80 md:h-80 object-contain animate-float drop-shadow-2xl relative z-20 " />
            <div className=" absolute top-10 left-20 w-24 h-24 rounded-full bg-[#6EE7B7]/30 blur-2xl animate-spin-slow"></div>
            <div className="absolute bottom-20 right-10  w-32 h-32 rounded-full bg-[#10B981]/30 blur-2xl animate-spin-slow "></div>
          </div>
      ...
      <div className="min-h-screen relative overflow-hidden bg-black flex flex-col md:flex-row items-start   py-32  px-6 md:px-20 ">
        ...
        <div className="flex-1 space-y-8 z-10">
          ...
          <ul className="text-white/90 list-disc pl-6 space-y-3 text-lg md:text-xl">
              <li><span className="font-semibold text-[#059669]" >Smart PDF Parsing:</span> Extract structured data from PDF resumes</li>
              <li><span className="font-semibold text-[#059669]" >Multiple Profile Support:</span> Manage different versions of your professional profile</li>
              <li><span className="font-semibold text-[#059669]" >Social Profile Detection:</span> Automatically extracts LinkedIn, GitHub, and personal website URLs</li>
              <li><span className="font-semibold text-[#059669]" >Visual Resume Dashboard:</span> View all your parsed resume data in a clean, organized interface</li>

          </ul>
          

          <div className="flex justify-center mt-8">
            <Link to={'/upload'} className="bg-[#059669]/70 text-white py-3 px-6 rounded-full shadow-lg hover:bg-[#10B981] transition">
      ...
      <div className="absolute inset-0 z-0"
       style={{
         backgroundImage: `
           repeating-linear-gradient(0deg, transparent, transparent 19px, rgba(5, 150, 105, 0.2) 20px),
           repeating-linear-gradient(90deg, transparent, transparent 19px, rgba(16, 185, 129, 0.2) 20px)
         `
       }}
      ></div>
      </div>
        ...
        <div className="relative w-full h-[60vh] border border-white/20  rounded-lg bg-black/80 flex items-center justify-center  overflow-hidden " ref={containerRef}>
          {containerRef.current && positions.length === steps.length && steps.map((step, index) => (
            <motion.div
              ...
              className="absolute bg-gradient-to-r from-[#059669] via-[#10B981] to-[#34D399] rounded-lg p-6 w-56  shadow-lg cursor-grab text-white"
   ...
   <div className="min-h-screen bg-gradient-to-l from-[#0F4C3A] to-black py-20 flex items-center flex-col px-6 md:px-20 relative">
...
<motion.div
  ...
  className="fixed top-0 left-0 h-full w-64 bg-gradient-to-b from-[#0F4C3A] to-black shadow-xl z-50 flex flex-col p-6 space-y-6"
>
 ...
 <footer className="mt-auto w-full bg-gradient-to-l from-[#0F4C3A] to-black py-16 px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div className="space-y-4">
            ...
            <img 
                src="/logo.jpg"   
                alt="Resume Craft AI Logo" 
                className="w-10 h-10 object-contain"
            />
            <h1 className="text-2xl font-bold font-heading text-white">
                Resume Craft <span className="text-[#34D399]">AI</span>
            </h1>
            </div>
            ...
            <div className="space-y-4">
             ...
             <div className="space-y-3">
              <a 
                href="/job-matches" 
                className="block text-[#34D399] hover:text-[#6EE7B7] transition-colors text-sm"
              >
                Jobs
              </a>
              <a 
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
          <span>© 2025 Resume Craft AI. All rights reserved.</span>
          <span>
             .
          </span>
        </div>
