...
function Me() {
  ...
  return (
    <div className="flex justify-center min-h-screen bg-gradient-to-l from-[#059669] to-black py-12 px-4">
      <div className="w-full max-w-3xl bg-black/50 rounded-xl shadow-lg overflow-hidden">
        <div className="bg-gradient-to-l from-[#059669] to-black  py-6 px-8">
          <h1 className="text-2xl font-bold text-[#34D399]/50">Your Profile</h1>
        </div>
        ...
        <div className="flex flex-col md:flex-row">
          <div className="p-6 flex flex-col items-center">
            ...
            <div className="mt-2 px-4 py-2 bg-[#34D399]/50 text-white/70 rounded-md text-sm font-medium text-center">
              Account Active
            </div>
          </div>
          ...
          <div className="flex-1 p-6">
            <div className="space-y-6">
              <div className="border-b border-gray-200 pb-4">
                <div className="flex items-center">
                  <User className="text-[#34D399]/50 w-5 h-5 mr-3" />
              ...
              <div className="border-b border-gray-200 pb-4">
                <div className="flex items-center">
                  <Mail className="text-[#34D399]/50 w-5 h-5 mr-3" />
              ...
              <div className="pb-2">
                <div className="flex items-center">
                  <Calendar className="text-[#34D399]/50 w-5 h-5 mr-3" />
            ...
            <Link to="/home">
               <button className="px-5 py-2 bg-[#34D399]/50 text-white rounded-md hover:bg-[#10B981] transition-colors mr-3">
                 View home
               </button>
             </Link>
